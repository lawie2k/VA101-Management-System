            ...
            return (
              ...
              >
                <div>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-semibold mt-1 flex items-center gap-2">
                        ...
                        <span>•</span>
                        <span className="flex items-center gap-0.5"><IconMapPin className="w-3.5 h-3.5" /> {job.location}</span>
                      </p>
                    </div>
                  ...
                  {/* Description */}
                  <p className="text-xs text-slate-650 font-medium leading-relaxed mt-4">
                    {job.description}
                  </p>
