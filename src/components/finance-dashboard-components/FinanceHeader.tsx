    ...
    <header className="h-16 border-b border-slate-200 bg-white flex items-center justify-between px-4 lg:px-8 z-30 shrink-0">
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="relative max-w-md w-full hidden sm:block">
          <input 
            ...
            className="w-full pl-10 pr-4 py-2 rounded-full border border-slate-200 text-sm focus:outline-none focus:border-[#ffcdbd] focus:ring-1 focus:ring-[#ffcdbd] bg-slate-50 transition-all text-slate-700 font-medium"
          />
      ...
      <div className="flex items-center gap-3 sm:gap-5">
        <button className="relative p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-full transition-colors">
          ...
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#E84E29] rounded-full border-2 border-white"></span>
        </button>
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex flex-col items-end">
            ...
            <span className="text-[10px] font-bold text-[#DA431E] uppercase tracking-wider">Finance Dept</span>
          </div>
          <div className="w-9 h-9 rounded-full bg-[#fff0ed] flex items-center justify-center text-[#DA431E] font-bold border border-[#ffcdbd] shrink-0">
            {fullName.charAt(0)}
          </div>
          <button 
