...
export default function Page() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold text-slate-800 mb-4">Browse Approved Jobs</h1>
      <p className="text-slate-600 mb-6">File path: <code>src/app/(dashboard)/jobs/page.tsx</code></p>
