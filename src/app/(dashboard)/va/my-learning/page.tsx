...
export default function Page() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold text-slate-800 mb-4">VA My Learning</h1>
      <p className="text-slate-600 mb-6">File path: <code>src/app/(dashboard)/va/my-learning/page.tsx</code></p>
