...
export default function Page() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold text-slate-800 mb-4">Client Post a Job</h1>
      <p className="text-slate-600 mb-6">File path: <code>src/app/(dashboard)/client/post-job/page.tsx</code></p>
